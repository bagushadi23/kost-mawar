...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2020 at 05:35 PM
...
(0, 800000, 'Available', 'Kost_Jenaka_Wanita_JW1.jpg', 'Kost Jenaka Wanita JW1', 'Yogyakarta', 'Mahasiswa', 'Jl Senowangung', 'banguntapan', 'skdhaskdhskal', 'KMD,KD,KASUR,AC,WIFI'),
...
(12, 1300000, 'Available', 'Kost_Sabirin_Eksklusif_S2.jpg', 'Kost Sabirin Eksklusif S2', 'Malang', 'Eksklusif', 'Malang', 'Malang', 'Malang', ',,,,,,,'),
...
(16, 800000, 'Available', 'Kost_Mawar_Wanita_M1_Yogya.jpg', 'Kost Mawar Wanita M1 Yogya', 'Yogyakarta', 'Mahasiswa', 'Jl senowangu', 'Jambitan', 'sadasdsad', ',,KASUR,AC,WIFI,,LOUNDRY,TV'),
...
(1, 'bnagantara', 'saddan11', 'bima nagantara', 'rejokusuman', 'L', 2),
...
--
ALTER TABLE `kost`
  MODIFY `idkost` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
