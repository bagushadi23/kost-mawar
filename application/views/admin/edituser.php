<div class="container">
    ...
    <form action="<?php echo base_url(). 'admin/dashboard/updateuser';?>" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nohp" name="nohp" value="<?php echo $k->nohp ?>">
        </div>
        <div class="form-group">
            <label for="harga">email</label>
            <input type="text" class="form-control" id="email" name="email" value="<?php echo $k->email ?>">
        </div>
        <div class="form-group">
