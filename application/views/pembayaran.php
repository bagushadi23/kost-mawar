        ...
        <table class="table">
            <tr>
                <thead class="thead-light">
                    <th scope="col">Jumlah DP Pembayaran</th>
                    <th scope="col">Konfirmasi Pembayaran</th>
                </thead>
            </tr>
            <tr>
                <tbody>
                    <td><?php echo rupiah($kost['harga']*0.7)?></td>
                    <td><a href="<?php echo base_url().'booking/konfirmasi/'.$kost['idkost'].'/'.$kost['harga']*0.7?>"><button class="btn btn-sm btn-primary">KONFORMASI</button></a></td>
                </tbody>
            </tr>
        </table>
